...
from anirecs.backend.app.schemas.animes import AnimeCreate, AnimeResponse, AnimesResponse, convert, TagResponse
from anirecs.backend.app.routers.users import get_current_user
from anirecs.backend.app.models import User, Anime, Tag
...
def recommend(
    ...
    return convert([item[1] for item in recommendation_list[0:min(len(recommendation_list),10)]])
